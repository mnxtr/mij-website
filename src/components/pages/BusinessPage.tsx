...
import { Package, Users, Code, TrendingUp, ArrowRight, CheckCircle2, Globe2, Handshake, Zap } from 'lucide-react';
        ...
        <div className="container mx-auto px-6 md:px-12">
          ...
          >
            ...
            <h1 className="text-5xl md:text-6xl lg:text-7xl font-bold mb-8 leading-tight">
              {t.business.hero.title} <span className="text-[#D4387F]">{t.business.hero.highlight}</span>
              <br />{t.business.hero.subtitle}
            </h1>
                    ...
                    <div className={`space-y-8 ${!isEven ? 'lg:col-start-2' : ''}`}>
                      ...
                      <Button 
                        ...
                        className={`text-white gap-3 px-8 py-6 transition-all ${
                          touchedButton === `get-started-${index}` ? 'bg-[#FF8FB8]' : 'bg-[#D4387F]'
                        } hover:bg-[#FF8FB8]`}
                        size="lg"
                        ...
                        <div className="relative overflow-hidden rounded-lg">
                          <ImageWithFallback
                            ...
                            className={`w-full h-[500px] object-cover transition-all duration-500 ${
                              animatedImages[`division-${index}`] ? 'grayscale-0' : 'grayscale'
                            } hover:grayscale-0`}
              ...
              <CardContent className="p-16 text-center">
                ...
                <div className="flex flex-wrap gap-4 justify-center">
                  <button
                    ...
                    onTouchEnd={() => setTimeout(() => setTouchedButton(null), 300)}
                    className={`inline-flex items-center justify-center gap-3 rounded-md px-10 py-7 text-base font-medium transition-all ${
                      touchedButton === 'schedule-consultation' ? 'bg-[#FF8FB8]' : 'bg-[#D4387F]'
                  ...
                  <button
                    ...
                    onTouchEnd={() => setTimeout(() => setTouchedButton(null), 300)}
                    className={`inline-flex items-center justify-center gap-3 rounded-md px-10 py-7 text-base font-medium transition-all ${
                      touchedButton === 'view-all-services' ? 'bg-[#FF8FB8]' : 'bg-[#D4387F]'
                    } text-white hover:bg-[#FF8FB8]`}
                    style={{ WebkitTapHighlightColor: 'transparent' }}
                  >
                    View All Services
